-- Aginno Video Editor - Database Bootstrap Schema
-- This file sets up the initial database schema for the video editor

-- Enable the pgvector extension (should already be created by setup script)
...
-- Frames table - stores extracted frames with AI analysis
...
CREATE INDEX IF NOT EXISTS idx_frames_embedding ON frames USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100);
